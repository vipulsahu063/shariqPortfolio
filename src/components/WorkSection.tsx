...
const WorkSection = () => {
  ...
  const memoizedProjects = useMemo(() => [
    ...
    { src: "/big.webp", alt: "Project Two", title: "002", span: "md:row-span-2 md:col-span-2", link: "https://www.behance.net/gallery/206535061/Social-Media-Campaign-Real-Estate" },
    ...
    { src: "/big (2).webp", alt: "Project Four", title: "004", span: "md:row-span-2 md:col-span-2", link: "https://www.behance.net/gallery/206028153/Educational-institutions-Social-Media-campaign" },
  ...
  return (
    <section id="work" className="px-4 sm:px-8 md:px-20 lg:px-40 xl:px-60">
      <h2 className="text-3xl font-bold mb-6">My Work</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12 lg:gap-16 xl:gap-20">
        {memoizedProjects.map(({ src, alt, title, span, link }) => (
          <a
            ...
            className={`relative overflow-hidden shadow-md transition-transform duration-300 ${span || "col-span-1 row-span-1"} flex items-end group`}
          >
            <img
              src={src}
              alt={alt}
              loading="lazy"
              className="w-full h-auto object-cover transition-transform duration-300 group-hover:scale-105 group-hover:blur-0 md:blur-sm"
            />
